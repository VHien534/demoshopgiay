...
namespace Project_63132041.Models
{
    ...
    public partial class Project_63132041Entities2 : DbContext
    {
        public Project_63132041Entities2()
            : base("name=Project_63132041Entities2")
        {
        }
        ...
        public virtual int KhachHang_TimKiem(string maKH, string hoTen)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("KhachHang_TimKiem", maKHParameter, hoTenParameter);
        }
    
        public virtual int NhanVien_TimKiem(string maNv, string hoTenNV)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("NhanVien_TimKiem", maNvParameter, hoTenNVParameter);
        }
